...
import com.example.myokhtttp.net.download.db.annotion.DbFiled;
import com.example.myokhtttp.net.download.db.annotion.DbTable;
 ...
 * @author:xuwh
 * @date:2019/7/28 0028 16:20
 * @UpdateUser： 更新者
 * @UpdateDate: 2019/7/28 0028 16:20
 * @UpdateRemark: 更新说明
 * @version:
 */
public abstract class BaseDao<T> implements IBaseDao<T> {
     ...
     * @UpdateUser: 更新者
     * @UpdateDate: 2019/7/28 0028 16:29
     * @UpdateRemark: 更新说明
     */
    private ContentValues getContentValues(T entity) {
        ...
        try {
            ...
            for (Map.Entry<String, Field> me : cacheMap.entrySet()) {
                if (null == me.getValue().get(entity)) {
                    continue;
                }
     ...
     * @dec : 方法的作用
     * @author :xuwh
     * @date : 2019/7/28 0028 16:37
     * @UpdateUser:     更新者
     * @UpdateDate:     2019/7/28 0028 16:37
     * @UpdateRemark:   更新说明
     */
